...
SCAPI SteamControllerDeviceEnum * SCCC SteamController_EnumControllerDevices();
SCAPI SteamControllerDeviceEnum * SCCC SteamController_NextControllerDevice(SteamControllerDeviceEnum *pCurrent);

// ----------------------------------------------------------------------------------------------
// Controller initialization

SCAPI SteamControllerDevice * SCCC SteamController_Open(const SteamControllerDeviceEnum *pEnum);
SCAPI void                    SCCC SteamController_Close(SteamControllerDevice *pDevice);
SCAPI bool                    SCCC SteamController_IsWirelessDongle(const SteamControllerDevice *pDevice);
SCAPI bool                    SCCC SteamController_TurnOff(const SteamControllerDevice *pDevice);
...
bool      SCAPI SCCC SteamController_QueryWirelessState(const SteamControllerDevice *pDevice, uint8_t *state);

bool      SCAPI SCCC SteamController_EnablePairing(const SteamControllerDevice *pDevice, bool enable, uint8_t deviceType);
bool      SCAPI SCCC SteamController_CommitPairing(const SteamControllerDevice *pDevice, bool connect);
...
bool      SCAPI SCCC SteamController_Configure(const SteamControllerDevice *pDevice, unsigned configFlags);
bool      SCAPI SCCC SteamController_SetHomeButtonBrightness(const SteamControllerDevice *pDevice, uint8_t brightness);
bool      SCAPI SCCC SteamController_SetTimeOut(const SteamControllerDevice *pDevice, uint16_t timeout);

// ----------------------------------------------------------------------------------------------
// State

uint8_t   SCAPI SCCC SteamController_ReadEvent(const SteamControllerDevice *pDevice, SteamControllerEvent *pEvent);
void      SCAPI SCCC SteamController_UpdateState(SteamControllerState *pState, const SteamControllerEvent *pEvent);

// ----------------------------------------------------------------------------------------------
// Feedback

bool      SCAPI SCCC SteamController_TriggerHaptic(const SteamControllerDevice *pDevice, uint16_t motor, uint16_t onTime, uint16_t offTime, uint16_t count);
void      SCAPI SCCC SteamController_PlayMelody(const SteamControllerDevice *pDevice, uint32_t melody);
